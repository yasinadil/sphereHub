...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "static md:relative z-10 flex max-w-max flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
