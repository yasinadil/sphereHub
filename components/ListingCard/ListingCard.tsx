        ...
        <Card>
          <CardHeader>
            <div className="m-auto relative">
              <div className="w-full h-[170px] rounded-2xl bg-center bg-cover">
                <Image
              ...
              {/* <div className=" flex flex-row top-2 justify-center card  rounded-full">
       {rooms.map((room, index) => {
         return <RxDotFilled className="cursor-pointer" key={index} />;
       })}
     </div> */}
            </div>
            ...
            <CardDescription>
              {props.ameneties.map((amenity: any, index: any) => {
                return (
                  <Badge className="w-fit" key={index} variant="outline">
                    {amenity}
                  </Badge>
                );
              })}
